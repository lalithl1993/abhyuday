...
if ($result = $mysqli->query($sql)) {
    ...
    $message_mail="Thank you for contacting us, you will get reply from our team soon <br>You can always contact us at <br> Sushant NAVALE +91-8095691761 <br> Anup KULKARNI +91-8971056407 <br> Kanika KHARBANDA +91-7348832662 <br> Abdul SAYEED +91-9663023543";// mail body
    ...
    // Compose
    $mail->SetFrom("msrit.abhyuday@gmail.com", "ABHYUDAY 3.0");//reply to emailid, name to display near subject
    $mail->AddReplyTo("msrit.abhyuday@gmail.com", "ABHYUDAY 3.0");// user can reply to this e mail
    $mail->Subject = "ABHYUDAY 3.0 @MSRIT";      // Subject (which isn't required)  
...
<div class="row" >
	...
	<div class="six columns category offstage">
		...
		<table id="details">
		<tr>
			<th colspan="2">FACULTY CO-ORDINATORS</th>
		</tr>
		<tr>
		...
		<tr>
			<th colspan="2">STUDENT CO-ORDINATORS</th>
		</tr>
		<tr>
			<td>ABDUL SAYEED</td>
			<td>+91-96630 23543  </td>
		</tr>
		<tr>
			<td>ANUP KULKARNI</td>
			<td>+91-89710 56407</td>
		</tr>
		<tr>
			<td>KANIKA KHARBANDA</td>
			<td>+91-73488 32662</td>
		</tr>
		<tr>
			<td>SUSHANT NAVALE</td>
			<td>+91-80956 91761</td>
		</tr>
