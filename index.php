...
<meta name="keywords" content="MSRIT fest,msrit fest,abhyuday,abhyuday 3.0,abhyuday 2016,msrit fest abhyuday,abhyuday technical fest,mca fest,ramaiah mca fest,ramaiah bca fest,www.msrit.edu,msrit.edu">
...
<div id="subheader">
	<div class="row">
		<div class="twelve columns">
			<p class="text-center">
				"ABHYUDAY 3.0" ON 17th AND 18th MARCH 2016
			</p>
		</div>
	</div>
</div>
	...
	<div class="twelve columns">
		<ul class="ca-menu">
			...
			<div class="ca-content">
				...
				<h3 class="ca-sub">Abhyuday 2.0 photos</h3>
			</div>
			</a>
			</li>
			<li>
...
<div class="row">
	<div class="twelve columns">
        ...
        <div class="video-container">
         <iframe src="https://www.youtube.com/embed/lVmmwx4IM-w" frameborder="0" width="560" height="315"></iframe>
        </div>
       <div class="centersectiontitle">
			<h4>Countdown</h4>
		</div>
	</div>
	<div class="alclock" style=" margin: 0 auto;margin-left: auto ;
  margin-right: auto ;"  >
