...
// js to create multiple student input boxes
     function textdisp(id) {
			...
			hide();
			    ...
			    unhide();
			document.getElementById("txtlist").innerHTML = "<img src='images/loading_events.gif'/>";
...
<div class="row">
	<div class="twelve columns">
    <form name="reg" action="regeister.svr.php" onsubmit="return all_valid();" method="POST">
    <fieldset>
